	...
	<c:when test="${EM_id==null}">
		<div class="l-wrap">
		  ...
		  <div class="login-menu" ondragstart='return false' onselectstart='return false'>
		  	<span class="logM2" onclick="logCk(2)" style="width:100%; border-color:rgb(96, 129, 247);">비밀번호 찾기</span>  	
		  </div>
		  <form action="" name="log2" method="post" class="log2" style="display:block;">																			
			  <div class="fom-wrap">
				  <div class="l-login-con passId">당신의 패스워드는
				    <input type="text" name="myId" value="${password}" placeholder="당신의 패스워드">
				  </div>
				  <div class="l-suumit-con passNext">
				    <input class="l-submit" type="button"value="로그인하러 가기" style="background:rgb(96, 129, 247)" onclick="ckPass()">
				  </div>
			  </div>
			  <script>
			  	function ckPass(){
			  		location.href="login?loginCk=0";		  		
			  	}
			  </script>
		  </form>
		  <div class="l-nave">
		    ...
		    <div class="sub-add">
		      <ul>
		        <li><a href="../JOIN/v1join">회원가입</a></li>
		        <li>｜</li>
