...
<c:choose>
	<c:when test="${userID==null&&emID==null}">
		<div class="l-wrap">
		  ...
		  <form action="loginPro?URL=${URL}&&kind=user" name="log1" method="post" class="log1" style="<c:choose><c:when test="${logCk.equals('0')||logCk=='0'}">display:block;</c:when><c:otherwise>display:none;</c:otherwise></c:choose>">  																						
			  <div class="fom-wrap">
		  ...
		  <form action="loginPro?URL=${URL}&&kind=corp" name="log2" method="post" class="log2" style="<c:choose><c:when test="${logCk.equals('1')||logCk=='1'}">display:block;</c:when><c:otherwise>display:none;</c:otherwise></c:choose>">																			
			  <div class="fom-wrap">
				  <div class="l-login-con">
				    <input type="text" name="id" value="test9" placeholder="아이디">
				    <input type="password" name="pw" value="test" placeholder="비밀번호">
				  </div>
				  <div class="l-suumit-con">
		  ...
		  <div class="l-nave">
		    ...
		    <div class="sub-add">
		      <ul>
		        <li><a href="../JOIN/joinSelect">회원가입</a></li>
		        <li>｜</li>
...
<div class="l-wrap">
		  ...
		  <div class="login-menu">
			  ...
			  <div class="fom-wrap">
				  <div class="l-login-con">
				    <h3 style=" text-align: center; padding: 50px 0; ">${userID} 님</h3>
				  </div>
				  <div class="l-suumit-con">
				    <a href="../LOGIN/logout?url=${URL}" class="l-submit" type="submit" style="width:auto; display:block; ">로그아웃</a>
				  </div>
			  </div>
		</div>
</c:when>
...
<div class="l-wrap">
		  ...
		  <div class="login-menu">
		  	<span class="logM1" onclick="logCk(1)" style="border-color: rgb(180, 184, 192); background: rgb(243, 243, 243);">일반 로그인</span>
		  	<span class="logM2" onclick="logCk(2)" style="border-color: rgb(96, 129, 247); background: rgb(248, 248, 248);">기업 로그인</span>
		  </div>
			  <div class="fom-wrap">
				  <div class="l-login-con">
				    <h3 style=" text-align: center; padding: 50px 0; ">${emID} 님</h3>
				  </div>
				  <div class="l-suumit-con">
				    <a href="../LOGIN/logout?url=${URL}" class="l-submit" type="submit" style="width:auto; display:block; background:rgb(96, 129, 247);">로그아웃</a>
				  </div>
			  </div>
		</div>
</c:when>
