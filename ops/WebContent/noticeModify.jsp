...
<form action="noticeModifyPro.no" method="post" name = "modifyform" class="car-content">
<input type = "hidden" name = "n_no" value = "${n.n_no}"/>
          ...
          <input name="title" placeholder="제목" type="text" id="title" value = "${n.n_title}"/>
           ...
           <div class="car-con">
          <textarea id="content" class="car-textCon" placeholder="내용" name="content" cols="68" rows="20">${n.n_content}</textarea>
          </div>
          <div class="">
