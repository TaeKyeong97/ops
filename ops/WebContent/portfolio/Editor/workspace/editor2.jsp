...
<div id="smart_editor2">
	...
	<header>
      ...
      <div class="head-wrapper">
        <div class="head-con">
          <div class="logo-con">
            <a href="#"><img src="../../images/common/opsLogoBlack.svg" width="159px" alt=""></a>
          </div>
          <!--마춤형 라이브러리-->
          ...
          <div class="gnb-con">
            ...
            <div class="document-save"><a href="#" onclick="return false">저장</a></div>
            <div>
...
<!-- 에디터 툴바 끝 -->
        ...
        <input class="title" type="title" name="title" value="" placeholder="제목" autocomplete="off">
      </article>
		<!-- //제목 영역 -->
		<!-- 입력 -->
		<div class="se2_input_area husky_seditor_editing_area_container">
			...
			<iframe src="about:blank" id="se2_iframe" name="se2_iframe" class="se2_input_wysiwyg" width="950px" height="300" title="글쓰기 영역 : 도구 모음은 ALT+F10을, 도움말은 ALT+0을 누르세요." frameborder="0" style="display:block;"></iframe>
			<textarea name="" rows="10" cols="100" title="HTML 편집 모드" class="se2_input_syntax se2_input_htmlsrc" style="display:none;outline-style:none;resize:none; top:68px;"> </textarea>
...
<div class="comm-pop" style="display:none;">
  ...
  <div class="Provision">
    <img src="img/Provision.png" alt="빅데이터 이미지 제공 : 픽사베이">
  </div>
  <div id="loding">
    <div class="con"></div>
  </div>
