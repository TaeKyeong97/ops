...
public class WeartherAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		ActionForward forward=new ActionForward("wearther2.jsp",false);
		//날씨서비스
		 ...
		 /*******************/
			...
			String longitude=request.getParameter("longitude");
		      ...
		      //강수 형태 (눈, 비) PTY 가 제일 먼저 JSON에 있기때문에 0번째에 담김
				...
				//온도 반올림을 위해 따로 담음
		        String obsrValue2=va.elementAt(1);		//풍속이 날씨정보보다 먼저 파씽이됨
		        ...
		        request.setAttribute("PTYS", PTYS);
		        request.setAttribute("obsrValuedou", obsrValuedou);
		        request.setAttribute("timeBG", timeBG);
		        /******************************************/
		        try{
